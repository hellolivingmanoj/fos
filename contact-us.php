...
<head>
    ...
    <title>HomieForever| Contact us</title>
                                    ...
                                    <div class="row">
                                        <div class="col-md-4 col-sm-4 col-lg-4">
                                            <div class="contact-info-box">
                                                ...
                                                <p itemprop="description">Phone +918327467287</p>
                                                <p itemprop="description">Phone 00000000000</p>
                                            </div>
                                        </div>
                                        <div class="col-md-4 col-sm-4 col-lg-4">
                                            <div class="contact-info-box">
                                                ...
                                                <p itemprop="description">CCCT Chisopani South Sikkim</p>
                                            </div>
                                        </div>
                                        <div class="col-md-4 col-sm-4 col-lg-4">
                                            <div class="contact-info-box">
                                                ...
                                                <p itemprop="description">prajalnewemail@gmail.com</p>
